...
import { GetAllMascotasUseCase } from "@/backend/context/Pet/app/GetAllMascota";
...
export async function GetAllMascotas():Promise<ResponseType<CardMascotaProps[]>> {
...
if (!session) {
    ...
    const useCase = new GetAllMascotasUseCase(petRepository);
