...
import { ConfirmEnableTwoFactorUseCase } from "@/backend/context/Auth/app/ConfirmEnableTwoFactorUseCase";
...
export default async function ConfirmEnableTwoFactorAction(
  ...
  try {
    ...
    const useCase = new ConfirmEnableTwoFactorUseCase(
      authRepository,
      otpRepository
    );
